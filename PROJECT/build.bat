...
IF "%~1" == "" GOTO PrintHelp:: if first arguments equals empty string (meaning the user didn't type in an argument)
...
if not defined DevEnvDir (
	call "C:\Program Files\Microsoft Visual Studio\2022\Community\Common7\Tools\VsDevCmd.bat" :: open developer command prompt if it hasn't been called yet
)
